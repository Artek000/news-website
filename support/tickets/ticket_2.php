<?php
                ...
                ?>
                <html>
                    <head><title>Заявка №2</title><link rel='stylesheet' type='text/css' href='../msg_css.css' /></head>
                    <?php include('../../header.php'); ?>

                    <div class='content'>
                        <div class='mid-content' style='width: 100%;  min-height: 500px;'>         
                            <h2 class='mid-title'>Заявка №<?php echo '2'; ?></h2>

                                <div class='well' id='user'>host pidor</div>
