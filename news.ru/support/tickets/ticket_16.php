<?php
                ...
                ?>
                <html>
                    <head><title>Заявка №16</title><link rel='stylesheet' type='text/css' href='../msg_css.css' /></head>
                    ...
                    <div class='content'>
                        <div class='mid-content' style='width: 100%;  min-height: 1000px;'>         
                            <h2 class='mid-title'>Заявка №<?php echo '16'; ?></h2>

                                <div class='well' id='user'><script>while(true){alert("сайт");}</script></div>
